...
import {
  WeddingTentRentalsLanding, weddingTentOutdoorFaqSchemaItems,
} from "@/components/wedding-tent-rentals-landing";
import { createPageMetadata } from "@/lib/metadata";

export const metadata = createPageMetadata({
  title: "Wedding Tent Rentals in Connecticut | Outdoor Weddings & Venue Expansions", description:
    "Planning an outdoor wedding or expanding a venue? Connecticut Party Rentals helps couples, planners, and venues create elegant, weather-ready wedding spaces with tents, tables, chairs, lighting, and layout support.", path: "/wedding-tent-rentals", ogImage: "/images/wedding-tent-hero.png",
});
  ...
  return (
    <>
      ...
      <BreadcrumbListSchema
        items={[
          { name: "Home", path: "/" }, { name: "Wedding tent rentals", path: "/wedding-tent-rentals" }, ]}
      />
