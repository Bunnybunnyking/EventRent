...
const looks = [
  {
    href: "/tents/gallery",
    title: "Tent gallery",
    description: "Real Connecticut setups: weddings, backyards, corporate, and community events. Click any photo for full size.",
    hint: "Browse photos",
  },
  {
    href: "/tents",
    title: "Tent families & sizes",
    description: "Frame, expandable, pole, large structures, and marquee walkways. Match structure to your layout and surface.",
    hint: "Explore tents",
  },
  {
    href: "/party-guides",
    title: "Party guides",
    description: "Short reads on sizing mindset, backyard checklists, rain plans, and flow before you quote.",
    hint: "Read guides",
  },
  {
    href: "/planning#size-guide",
    title: "Planning tools",
    description: "Square-footage calculator, capacity chart, and Quick Event Planner in one place.",
    hint: "Open tools",
  },
] as const;
...
export function EventLooksSection({ variant }: { variant: Variant }) {
  ...
  return (
    <section className="border-b border-stone-200 bg-gradient-to-b from-[#fffefb] to-[#faf8f5] py-10 sm:py-12" aria-labelledby="event-looks-heading">
