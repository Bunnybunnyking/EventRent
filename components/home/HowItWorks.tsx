const steps = [
  {
    n: 1,
    title: "Tell us your date + town",
    body: "Share what you are hosting and where—rough headcount is enough to start.",
  },
  {
    n: 2,
    title: "We confirm size, layout, and site needs",
    body: "Staking, access, rain backup, and flow—we line it up with your site, not a generic chart.",
  },
  {
    n: 3,
    title: "We deliver, set up, and break down",
    body: "Our crew handles install and pickup so you are not juggling rentals on event day.",
  },
] as const;

export function HowItWorks() {
  return (
    <section className="border-y border-stone-200 bg-[#faf8f5] py-12 sm:py-14 lg:py-16" aria-labelledby="home-how-heading">
