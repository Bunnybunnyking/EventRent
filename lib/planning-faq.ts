...
export const planningFaqItems = [
  {
    ...
    question: "What size tent do I need for 100 guests?", answer:
    ...
    question: "Do I need a tent if the forecast looks clear?", answer:
    ...
    question: "Can you set up on a driveway or parking lot?", answer:
    ...
    question: "What if my yard is sloped?", answer:
    ...
    question: "Do I need sidewalls?", answer:
    ...
    question: "How much space do I need beyond tables and chairs?", answer:
    ...
    question: "Can you help if I do not have my final layout yet?", answer:
    ...
    question: "When should I book?", answer:
    ...
    question: "Do permits matter for tent rentals in Connecticut?", answer:
