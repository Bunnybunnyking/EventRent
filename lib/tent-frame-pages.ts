import { goodshuffleFieldsForFrameSizePage } from "./goodshuffle-catalog-ids";
...
export const frameTentPages: Record<string, TentSizePageData> = {
  "10x10-frame-tent-rental": {
    ...
    ...goodshuffleFieldsForFrameSizePage("10x10-frame-tent-rental"),
    sizeLabel: "10×10",
    sqft: 100,
  ...
  "12x12-frame-tent-rental": {
    ...
    ...goodshuffleFieldsForFrameSizePage("12x12-frame-tent-rental"),
    sizeLabel: "12×12",
    sqft: 144,
  ...
  "16x16-frame-tent-rental": {
    ...
    ...goodshuffleFieldsForFrameSizePage("16x16-frame-tent-rental"),
    sizeLabel: "16×16",
    sqft: 256,
  ...
  "20x20-frame-tent-rental": {
    ...
    sizeLabel: "20×20",
    sqft: 400,
    ...goodshuffleFieldsForFrameSizePage("20x20-frame-tent-rental"),
    ...
    guestSeatedEstimate: "Often roughly 32 to 48 seated at rounds when aisles and service stay realistic.",
    ...
    faqs: [
      {
        ...
        answer:
          "Often roughly 32 to 48 seated at rounds when aisles and head table stay reasonable. Cocktail counts run higher. We confirm with your actual layout, not a chart alone.",
      },
      {
  ...
  "20x30-frame-tent-rental": {
    ...
    ...goodshuffleFieldsForFrameSizePage("20x30-frame-tent-rental"),
    sizeLabel: "20×30",
    sqft: 600,
    ...
    guestSeatedEstimate: "Often roughly 48 to 72 seated at rounds when dance and service zones are sized intentionally.",
  ...
  "20x40-frame-tent-rental": {
    ...
    ...goodshuffleFieldsForFrameSizePage("20x40-frame-tent-rental"),
    sizeLabel: "20×40",
    sqft: 800,
    ...
    guestSeatedEstimate: "Often roughly 50 to 65 seated at rounds when dance, buffet, and aisles stay intentional.",
  ...
  "30x30-frame-tent-rental": {
    ...
    ...goodshuffleFieldsForFrameSizePage("30x30-frame-tent-rental"),
    sizeLabel: "30×30",
    sqft: 900,
    ...
    guestSeatedEstimate: "Often roughly 60 to 80 seated at rounds when dance, head table, and buffet are balanced.",
  ...
  "30x45-frame-tent-rental": {
    ...
    ...goodshuffleFieldsForFrameSizePage("30x45-frame-tent-rental"),
    sizeLabel: "30×45",
    sqft: 1350,
    ...
    guestSeatedEstimate: "Often roughly 90 to 120 seated at rounds when dance, stage, and buffet are modeled, not guaranteed maximums.",
  ...
  "30x60-frame-tent-rental": {
    ...
    ...goodshuffleFieldsForFrameSizePage("30x60-frame-tent-rental"),
    sizeLabel: "30×60",
    sqft: 1800,
    ...
    guestSeatedEstimate: "Often roughly 100 to 140+ seated at rounds when stage, dance, and buffet are balanced, always layout-dependent.",
