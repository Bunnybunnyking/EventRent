...
export const partyGuideCategories: { id: PartyGuideCategory | "all"; label: string }[] = [
  ...
  { id: "tent", label: "Tent size guides" },
  { id: "party_tips", label: "Party planning tips" },
  { id: "wedding", label: "Wedding tent guides" },
  { id: "backyard", label: "Backyard event guides" },
  { id: "layout", label: "Layout & seating" },
  { id: "weather", label: "Rain plan & weather" },
  { id: "logistics", label: "Event logistics" },
  { id: "graduation", label: "Graduation guides" },
  { id: "corporate", label: "Corporate event guides" },
  { id: "inspiration", label: "Inspiration & ideas" },
];

const guides: PartyGuideArticle[] = [
  {
    slug: "how-to-think-about-tent-size-before-you-quote",
    title: "How to think about tent size before you quote",
    metaDescription:
      "Practical steps to estimate tent footprint in Connecticut: layout first, guest count second, and what changes the math for dance floors, buffets, and weather.",
    category: "tent",
    categoryLabel: "Tent size guides",
    publishedAt: "2025-11-01",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Start with how people move, not how many people RSVP.",
    intro:
      "The fastest way to pick the wrong tent is to match guest count to a chart and stop. The right tent fits your layout: seated rounds, aisles, dance floor, bar lines, buffet, and weather strategy. This guide gives you a simple order of operations before you request a quote.",
    featured: true,
    toc: [
      { id: "layout-first", label: "Why layout comes first" },
      { id: "guest-count", label: "Where guest count still matters" },
      { id: "what-changes-math", label: "What changes the math" },
      { id: "next-step", label: "What to send us for a useful quote" },
    ],
    sections: [
      {
        id: "layout-first",
        heading: "Why layout comes first",
        body:
          "Ceremony in the round, buffet along one wall, or dance floor inside the same roofline all use space differently. Sketch how you want the day to feel, then we translate that into footprint. Our frame tent pages (10×10 through 30×60 class sizes), expandable 20′ and 30′ systems, pole tents, marquee walkways, and 60×60–60×150 large structures each solve different layout problems. Your program picks the family, not the other way around.",
      },
      {
        id: "guest-count",
        heading: "Where guest count still matters",
        body:
      ...
      {
        id: "next-step",
        heading: "What to send us for a useful quote",
        body:
    ...
    callouts: [
      {
        title: "Quick tip",
        body: "If you hope for dancing and buffet inside the same tent, say so up front. We would rather size once than shuffle furniture the week of the event.",
      },
    ],
    checklist: [
    ...
    faq: [
      {
        question: "Is there a single chart that picks my tent?",
        answer:
          "No trustworthy one. Charts help as a conversation starter. Your site, program, and furniture plan decide what fits.",
      },
      {
        question: "Should I use the quick planner first?",
        answer:
          "If you want structured prompts, yes. You can also contact us with a short note and we will ask the right follow ups.",
      },
    ],
    relatedSlugs: [
      "what-fits-in-a-20x40-tent-connecticut",
      "frame-tent-vs-pole-tent-connecticut",
      "backyard-party-checklist-connecticut",
    ],
  },
  {
    slug: "what-fits-in-a-20x40-tent-connecticut",
    title: "What fits in a 20×40 tent in Connecticut?",
    metaDescription:
      "A practical look at 800 square feet under a 20×40 frame or expandable bay: seated counts, buffet and bar lines, dance floor tradeoffs, and when to size up.",
    category: "tent",
    categoryLabel: "Tent size guides",
    publishedAt: "2026-01-10",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Eight hundred square feet is flexible, not magic. Layout still wins.",
    intro:
    ...
    toc: [
      { id: "sqft", label: "The real square footage" },
      { id: "programs", label: "Programs that fit comfortably" },
      { id: "tradeoffs", label: "Tradeoffs and add-ons" },
      { id: "inventory", label: "How this maps to our inventory" },
    ],
    sections: [
      {
        id: "sqft",
        heading: "The real square footage",
        body:
      ...
      {
        id: "programs",
        heading: "Programs that fit comfortably",
        body:
      ...
      {
        id: "inventory",
        heading: "How this maps to our inventory",
        body:
    ...
    callouts: [
      {
        title: "Size page",
        body: "See our 20×40 frame tent page for inventory-aware notes and photo placeholders you can pair with this guide.",
      },
    ],
    faq: [
      {
        question: "Is a 20×40 enough for eighty seated guests?",
        answer:
    ...
    relatedSlugs: ["how-to-think-about-tent-size-before-you-quote", "buffet-dj-bar-dance-floor-footprint"],
  },
  {
    slug: "frame-tent-vs-pole-tent-connecticut",
    title: "Frame tent vs pole tent: what Connecticut hosts should know",
    metaDescription:
      "Compare clear-span frame tents and classic pole tents: interior poles, surfaces, style, and when each family fits weddings, backyards, and corporate events.",
    category: "tent",
    categoryLabel: "Tent size guides",
    publishedAt: "2026-02-01",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Clear-span vs classic peaks: the tradeoff is layout and site as much as looks.",
    intro:
    ...
    toc: [
      { id: "frame", label: "Frame tents" },
      { id: "pole", label: "Pole tents" },
      { id: "choose", label: "How we help you choose" },
    ],
    sections: [
      {
        id: "frame",
    ...
    faq: [
      {
        question: "Can I mix frame and pole on one property?",
        answer:
    ...
    relatedSlugs: ["how-to-think-about-tent-size-before-you-quote", "wedding-reception-tent-layout-priorities"],
  },
  {
    slug: "wedding-reception-tent-layout-priorities",
    title: "Wedding reception tent layout priorities",
    metaDescription:
      "Plan an outdoor wedding tent layout: ceremony vs reception, dance floor placement, buffet and bar lines, head table, and weather backup in Connecticut.",
    category: "wedding",
    categoryLabel: "Wedding tent guides",
    publishedAt: "2025-12-01",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Decide what must happen under one roof, then size the roof.",
    intro:
    ...
    featured: true,
    toc: [
      { id: "zones", label: "Zones under one tent" },
      { id: "flow", label: "Service and guest flow" },
      { id: "backup", label: "Weather and sidewalls" },
    ],
    sections: [
      {
        id: "zones",
        heading: "Zones under one tent",
        body:
      ...
      {
        id: "flow",
        heading: "Service and guest flow",
        body:
      ...
      {
        id: "backup",
        heading: "Weather and sidewalls",
        body:
          "Sidewall style affects light, breeze, and temperature. Planning walls with the tent keeps anchoring coherent. See our rain plan guide for messaging and comfort level.",
      },
    ],
    faq: [
      {
        question: "Do we need a separate tent for catering prep?",
        answer:
          "Often yes when cooking or heavy prep runs hot. Guest tents stay for dining and dancing; prep stays ventilated and separate.",
      },
    ],
    relatedSlugs: ["outdoor-wedding-rain-plan-basics", "what-fits-in-a-20x40-tent-connecticut"],
  },
  {
    slug: "backyard-party-checklist-connecticut",
    title: "Backyard party checklist for Connecticut hosts",
    metaDescription:
      "A practical checklist for tented backyard parties: access, lawn, utilities, neighbor timing, and how to line up tents, tables, and weather backup.",
    category: "backyard",
    categoryLabel: "Backyard event guides",
    publishedAt: "2025-10-15",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Access, lawn, and utilities matter as much as the guest list.",
    intro:
    ...
    featured: true,
    toc: [
      { id: "access", label: "Access and parking" },
      { id: "lawn", label: "Lawn and underground utilities" },
      { id: "flow", label: "Guest flow and noise" },
      { id: "weather", label: "Weather and backup" },
    ],
    sections: [
      {
        id: "access",
      ...
      {
        id: "lawn",
        heading: "Lawn and underground utilities",
        body:
    ...
    callouts: [
      {
        title: "Connecticut note",
        body: "Spring mud and fall leaves both affect access and staking. Mention seasonal conditions when you quote.",
      },
    ],
    faq: [
      {
        question: "Do you stake every backyard tent?",
        answer:
          "Often on grass we stake when it is safe and allowed. Hard surfaces may use ballasts instead. Site review decides.",
      },
    ],
    relatedSlugs: ["how-to-think-about-tent-size-before-you-quote", "graduation-party-tent-backyard-connecticut"],
  },
  {
    slug: "outdoor-wedding-rain-plan-basics",
    title: "Outdoor wedding rain plan basics",
    metaDescription:
      "Plan an outdoor wedding with realistic weather backup: tents, sidewalls, guest messaging, and when to adjust layout instead of panicking.",
    category: "weather",
    categoryLabel: "Rain plan & weather",
    publishedAt: "2025-09-20",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Backup is a layout decision, not only a weather app.",
    intro:
      "Rain plans work best when they are built into the rental and layout from the start. Sidewalls, anchoring, and guest messaging should match the level of comfort you want if the sky does not cooperate.",
    toc: [
      { id: "comfort", label: "Define comfort level" },
      { id: "sidewalls", label: "Sidewalls and airflow" },
      { id: "message", label: "Guest messaging" },
    ],
    sections: [
      {
        id: "comfort",
        heading: "Define comfort level",
        body:
          "Decide what still feels like a celebration in light rain. That answer drives tent size, sidewall style, and whether parts of the program move under cover.",
      },
      {
        id: "sidewalls",
        heading: "Sidewalls and airflow",
        body:
          "Solid, window, and clear panels behave differently for wind, light, and temperature. We help you pick wall types that match your season and site.",
      },
      {
        id: "message",
        heading: "Guest messaging",
        body:
          "A short note on the website or invite about outdoor elements and footwear sets expectations and reduces day of stress.",
      },
    ],
    faq: [
      {
        question: "Should we add sidewalls at the last minute?",
        answer:
          "Sometimes, but walls are best planned with the tent so anchoring and layout stay coherent. Ask during quoting.",
      },
    ],
    relatedSlugs: ["wedding-reception-tent-layout-priorities", "backyard-party-checklist-connecticut"],
  },
  {
    slug: "buffet-dj-bar-dance-floor-footprint",
    title: "Buffet, bar, DJ, and dance floor: planning the footprint",
    metaDescription:
      "Allocate space for buffet lines, bars, DJ or band, and dance floors under a tent: layout rules that prevent crowding in Connecticut events.",
    category: "layout",
    categoryLabel: "Layout & seating",
    publishedAt: "2026-01-20",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Service and entertainment zones steal more room than tables alone.",
    intro:
    ...
    toc: [
      { id: "buffet", label: "Buffet and stations" },
      { id: "bar", label: "Bars and lines" },
      { id: "dance", label: "Dance floor and sound" },
      { id: "split", label: "When to split into two tents" },
    ],
    sections: [
      {
        id: "buffet",
        heading: "Buffet and stations",
        body:
      ...
      {
        id: "split",
        heading: "When to split into two tents",
        body:
    ...
    faq: [
      {
        question: "Can the dance floor sit outside the main tent?",
        answer:
          "Sometimes, if weather and surface allow and guests understand footwear. We still plan lighting and safety.",
      },
    ],
    relatedSlugs: ["what-fits-in-a-20x40-tent-connecticut", "corporate-picnic-tent-flow-basics"],
  },
  {
    slug: "graduation-party-tent-backyard-connecticut",
    title: "Graduation party tent setup for backyards",
    metaDescription:
      "Plan a Connecticut graduation party under tent: guest flow, speeches, food lines, tables and chairs, and weather backup for busy spring weekends.",
    category: "graduation",
    categoryLabel: "Graduation guides",
    publishedAt: "2026-03-01",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Graduations mix emotion, traffic, and food lines. Give the layout room.",
    intro:
    ...
    toc: [
      { id: "arrival", label: "Arrival and crowd timing" },
      { id: "food", label: "Food and seating" },
      { id: "weather", label: "Spring weather" },
    ],
    sections: [
      {
        id: "arrival",
        heading: "Arrival and crowd timing",
        body:
    ...
    faq: [
      {
        question: "Do you rent chairs and tables with the tent?",
        answer:
    ...
    relatedSlugs: ["backyard-party-checklist-connecticut", "buffet-dj-bar-dance-floor-footprint"],
  },
  {
    slug: "tented-event-details-people-forget",
    title: "Things people forget when planning a tented event",
    metaDescription:
      "Power, bathrooms, walkways, generator placement, catering rules, and neighbor timing: the logistics checklist Connecticut hosts overlook.",
    category: "logistics",
    categoryLabel: "Event logistics",
    publishedAt: "2026-02-15",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Tents solve cover. Logistics solve comfort.",
    intro:
    ...
    toc: [
      { id: "power", label: "Power and lighting" },
      { id: "comfort", label: "Restrooms and walkways" },
      { id: "rules", label: "Neighbors and timing" },
    ],
    sections: [
      {
        id: "power",
        heading: "Power and lighting",
        body:
      ...
      {
        id: "comfort",
        heading: "Restrooms and walkways",
        body:
    ...
    faq: [
      {
        question: "Do you coordinate with caterers?",
        answer:
    ...
    relatedSlugs: ["backyard-party-checklist-connecticut", "corporate-picnic-tent-flow-basics"],
  },
  {
    slug: "corporate-picnic-tent-flow-basics",
    title: "Corporate picnic tent flow basics",
    metaDescription:
      "Plan company picnics and staff events with better tent flow: arrival, food lines, programming, and teardown that matches your run of show.",
    category: "corporate",
    categoryLabel: "Corporate event guides",
    publishedAt: "2025-08-01",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Lines and programming eat space. Plan for both.",
    intro:
    ...
    toc: [
      { id: "arrival", label: "Arrival and queues" },
      { id: "food", label: "Food service style" },
      { id: "wrap", label: "Wrap and load out" },
    ],
    sections: [
      {
        id: "arrival",
        heading: "Arrival and queues",
        body:
          "Give guests a single obvious entry. If badges or wristbands are in play, keep that line out of the buffet line.",
      },
      {
        id: "food",
        heading: "Food service style",
        body:
    ...
    faq: [
      {
        question: "Do you work with AV vendors?",
        answer:
          "Yes. Share stage size and power needs early so tent placement and ballast plans stay realistic.",
      },
    ],
    relatedSlugs: ["buffet-dj-bar-dance-floor-footprint", "tented-event-details-people-forget"],
  },
  {
    slug: "five-questions-before-you-rent-a-tent",
    title: "Five questions to ask before you rent a tent",
    metaDescription:
      "Date, site, guest flow, weather comfort, and service needs: the questions that make a Connecticut tent quote actually useful.",
    category: "party_tips",
    categoryLabel: "Party planning tips",
    publishedAt: "2026-03-15",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "A good quote starts with how the day runs, not only how many people come.",
    intro:
    ...
    toc: [
      { id: "date", label: "Date and load-in reality" },
      { id: "site", label: "Site and access" },
      { id: "flow", label: "Guest flow and program" },
      { id: "weather", label: "Weather comfort" },
      { id: "service", label: "Food and entertainment" },
    ],
    sections: [
      {
        id: "date",
        heading: "Date and load-in reality",
        body:
          "Town events, school calendars, and holiday weekends affect crew windows. Share the full day, not only the party hours.",
      },
      {
        id: "site",
        heading: "Site and access",
        body:
      ...
      {
        id: "flow",
        heading: "Guest flow and program",
        body:
      ...
      {
        id: "service",
        heading: "Food and entertainment",
        body:
    ...
    faq: [
      {
        question: "Can I answer these in the Quick Event Planner?",
        answer:
          "Yes. The planner captures many of the same prompts so you arrive at a quote conversation with structure.",
      },
    ],
    relatedSlugs: ["how-to-think-about-tent-size-before-you-quote", "tented-event-details-people-forget"],
  },
  {
    slug: "connecticut-tented-party-inspiration-starters",
    title: "Connecticut tented party inspiration starters",
    metaDescription:
      "Ideas for backyard parties, weddings, graduations, and corporate events using real tent families and inventory: frame, expandable, pole, structures, and walkways.",
    category: "inspiration",
    categoryLabel: "Inspiration & ideas",
    publishedAt: "2026-04-01",
    updatedAt: "2026-04-13",
    reviewedBy: "Connecticut Party Rentals planning team",
    excerpt: "Match the mood to the structure, then call us for the real math.",
    intro:
      "Inspiration should still answer practical questions: how guests arrive, where they eat, and what happens if it rains. Use these starters as creative prompts, then bring them to our team with your date and town so we translate ideas into inventory you can book.",
    toc: [
      { id: "backyard", label: "Backyard and private" },
      { id: "wedding", label: "Weddings" },
      { id: "public", label: "Corporate and community" },
    ],
    sections: [
      {
        id: "backyard",
        heading: "Backyard and private",
        body:
      ...
      {
        id: "public",
        heading: "Corporate and community",
        body:
          "Festivals and town programs lean on large structures, queue controls, and repeatable layouts. We align load in windows with parks and schools.",
      },
    ],
    faq: [
      {
        question: "Where should I look for photos?",
        answer:
          "Start with our tent gallery, then walk tent family pages for structure context. Party guides add the planning narrative.",
      },
    ],
    relatedSlugs: ["how-to-think-about-tent-size-before-you-quote", "wedding-reception-tent-layout-priorities"],
  },
